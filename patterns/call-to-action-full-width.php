...
<div class="wp-block-group"><!-- wp:heading {"textColor":"fixed-base"} -->
<h2 class="wp-block-heading has-fixed-base-color has-text-color">Ready to Build Your Next Site?</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"fixed-base"} -->
<p class="has-fixed-base-color has-text-color">Create a lightning-fast website using the power of the WordPress Site Editor and stunning pre-made designs from Noon - all without the need for coding skills.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"fixed-base","textColor":"accent","className":"is-style-secondary-button"} -->
<div class="wp-block-button is-style-secondary-button"><a class="wp-block-button__link has-accent-color has-fixed-base-background-color has-text-color has-background wp-element-button">Download Noon Today</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
