...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/hero-bg.webp","id":725,"dimRatio":30,"focalPoint":{"x":0.5,"y":0.5},"minHeight":80,"minHeightUnit":"vh","gradient":"noon-base","contentPosition":"center center","align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"bottom":"0","top":"0","right":"0","left":"0"}}}} -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"textColor":"contrast-3","layout":{"type":"constrained","contentSize":"600px"}} -->
<div class="wp-block-group has-contrast-3-color has-text-color"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"text-base"} -->
